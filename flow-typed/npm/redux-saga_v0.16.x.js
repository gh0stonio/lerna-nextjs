...
declare module 'redux-saga' {
  ...
  declare export var runSaga: {
    ...
    <R, T1, T2, Fn: (t1: T1, t2: T2) => Saga<R>>(options: RunSagaOptions, saga: Fn, t1: T1, t2: T2): Task<R>,
  ...
  declare interface SagaMiddleware {
    ...
    run: {
      ...
      <R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => Saga<R>>(saga: Fn, t1: T1, t2: T2, t3: T3): Task<R>,
      <R, T1, T2, T3, T4, Fn: (t1: T1, t2: T2, t3: T3, t4: T4) => Saga<R>>(
        saga: Fn,
        t1: T1,
        t2: T2,
...
declare module 'redux-saga/effects' {
  ...
  declare export var call: {
    ...
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(cfn: [Ctx, Fn], t1: T1, t2: T2): CallEffect<Ctx, Fn, [T1, T2]>,
  ...
  declare export var apply: {
    ...
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(ctx: Ctx, fn: Fn, t1: T1, t2: T2): CallEffect<Ctx, Fn, [T1, T2]>,
    <Ctx, R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => R>(
      ctx: Ctx,
      fn: Fn,
      t1: T1,
  ...
  declare export var cps: {
    ...
    <R, T1, T2, T3, T4, T5, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, cb: NodeCallback<R>) => void>(
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
    ...
    <R, T1, T2, T3, T4, T5, T6, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, cb: NodeCallback<R>) => void>(
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
    ...
    <Ctx, R, T1, Fn: (t1: T1, cb: NodeCallback<R>) => void>(cfn: [Ctx, Fn], t1: T1): CpsEffect<Ctx, Fn, [T1]>,
    ...
    <Ctx, R, T1, T2, T3, T4, T5, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, cb: NodeCallback<R>) => void>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2,
      t3: T3,
    ...
    <Ctx, R, T1, T2, T3, T4, T5, T6, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, cb: NodeCallback<R>) => void>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2,
      t3: T3,
  ...
  declare export var fork: {
    ...
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(cfn: [Ctx, Fn], t1: T1, t2: T2): ForkEffect<Ctx, Fn, [T1, T2]>,
    <Ctx, R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => R>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2,
  ...
  declare export var spawn: {
    ...
    <Ctx, R, T1, T2, Fn: (t1: T1, t2: T2) => R>(cfn: [Ctx, Fn], t1: T1, t2: T2): SpawnEffect<Ctx, Fn, [T1, T2]>,
    <Ctx, R, T1, T2, T3, Fn: (t1: T1, t2: T2, t3: T3) => R>(
      cfn: [Ctx, Fn],
      t1: T1,
      t2: T2,
  ...
  declare export var select: {
    ...
    <S, R, T1, T2, T3, T4, T5, T6, Fn: (state: S, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => R>(
      fn: Fn,
      t1: T1,
      t2: T2,
      t3: T3,
  ...
  declare export var takeEvery: {
    // normal calls
    <A, R, Fn: (action: A) => Saga<R>>(pattern: Pattern, fn: Fn): ForkEffect<null, Function, $ReadOnlyArray<any>>,
    ...
    <A, R, T1, T2, T3, T4, T5, T6, Fn: (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, action: A) => Saga<R>>(
      pattern: Pattern,
      fn: Fn,
      t1: T1,
      t2: T2,
    ...
    // with channel
    <A, R, Fn: (action: A) => Saga<R>>(channel: Channel, fn: Fn): ForkEffect<null, Function, $ReadOnlyArray<any>>,
    <A, R, T1, Fn: (t1: T1, action: A) => Saga<R>>(
      channel: Channel,
      fn: Fn,
      t1: T1
  ...
  declare export var throttle: {
    // normal calls
    <A, R, Fn: (action: A) => Saga<R>>(ms: number, pattern: Pattern, fn: Fn): ForkEffect<null, Function, []>,
    <A, R, T1, Fn: (t1: T1, action: A) => Saga<R>>(
      ms: number,
      pattern: Pattern,
      fn: Fn,
